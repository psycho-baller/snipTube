import React, { useState, useRef, type KeyboardEvent, type FC, useEffect } from "react";
...
const InputTag: FC<Props> = (props) => {
  ...
  useEffect(() => {
    ...
    setWidth(span.current.getBoundingClientRect().width < 1 ? 1 : span.current.getBoundingClientRect().width);
  }, [inputVal]);
